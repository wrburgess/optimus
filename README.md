...
- Never commit the `.key` files; share development keys within the team privately and configure staging/production keys as `RAILS_MASTER_KEY` environment variables in their respective deployments.
